    ...
    <section className="stats-section fade-in-section">
      <div className="stats-container">
        <div className="stat-card">
          <span className="text-[#38BDF8] font-extrabold text-3xl tracking-tight stat-number">
            2500+
          </span>
        ...
        <div className="stat-card">
          <span className="text-[#38BDF8] font-extrabold text-3xl tracking-tight stat-number" style={{ fontSize: '2rem' }}>
            Platino 2
          </span>
